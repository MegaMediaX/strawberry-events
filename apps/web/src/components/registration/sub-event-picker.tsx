        ...
        <section key={category}>
          ...
          <ul>
            {items.map((se) => {
              ...
              const on = qty > 0;
              // dateStamp/timeRange render the venue wall-clock, never the
              // viewer's zone — the same pinning `fmt` used via
              // VENUE_TIME_ZONE. Do not swap either for a bare toLocaleString.
